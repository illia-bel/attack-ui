...
export default {
  ...
  attackConfigPage: {
    ...
    attackStartedDialog: {
      ...
      description : 'Поки ви не натиснете кнопку "Стоп" або не закриєте вкладку, атака буде активною. Запуск може тривати до 1 хвилини',
      okBtnLabel  : 'Ок',
    },
  ...
  denialOfResponsibilityWarning: {
    message    : 'Цей сайт є проектом для тестування ваших власних проектів. Адміністрація не несе жодної відповідальності за незаконне використання цього ресурсу',
    okBtnLabel : 'Ок',
  },
}
