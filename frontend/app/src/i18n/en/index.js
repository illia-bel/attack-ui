...
export default {
  ...
  attackConfigPage: {
    ...
    attackStartedDialog: {
      ...
      description : 'Until you press the "Stop" button or close the tab, the attack will be active. Startup may take up to 1 minute',
      okBtnLabel  : 'Ok',
    },
  ...
  denialOfResponsibilityWarning: {
    message    : 'This site is a project for load testing your own projects. The administration does not bear any responsibility for the illegal use of this resource',
    okBtnLabel : 'Ok',
  },
}
